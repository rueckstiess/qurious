...
class LoraManager:
    ...
    #         save_path = Path(self.config.training.checkpoint_dir) / adapter_name
    #     else:
    ...
    #         base_path = Path(self.config.training.checkpoint_dir)
    #     else:
    ...
    #         load_path = Path(self.config.training.checkpoint_dir) / adapter_name
    #     else:
    ...
    #     adapter_model = get_peft_model(self.model, peft_config)
