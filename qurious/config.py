...
def _deprecated_config_class(cls):
    """Decorator to mark a config class as deprecated."""
    original_init = cls.__init__

    def __init__(self, *args, **kwargs):
        warnings.warn(
            f"{cls.__name__} is deprecated and will be removed in a future version. Use Config class instead.",
            DeprecationWarning,
            stacklevel=2,
        )
...
@_deprecated_config_class
class PathConfig(Config):
    """Deprecated path configuration."""
...
class TrainingConfig(Config):
    """Deprecated training configuration."""
